...
const tagIcons: Record<string, string> = {
  ...
  "Reids": "https://www.vectorlogo.zone/logos/redis/redis-icon.svg",
...
const projects = [
  {
    title: "Route-LLM",
    description: "An intelligent routing system that dynamically directs user queries to the most appropriate LLM provider based on cost, latency, and capability requirements. Features real-time load balancing and fallback mechanisms.",
    tags: ["Python", "Redis", "Streamlit"],
    link: "https://github.com/ghoshsoham71/route-llm",
    github: "https://github.com/ghoshsoham71/route-llm"
  },
  {
...
const Portfolio = () => {
  ...
  const resumeUrl = "https://drive.google.com/file/d/1EEUzrkxH00jljkeaOBou0PBuYfyXdS6-/view?usp=sharing";
